...
cd "/home/dawei/catkin-ws/src/recycle/gazebo2rviz"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/dawei/catkin-ws/src/recycle/gazebo2rviz/setup.py" \
    build --build-base "/home/dawei/catkin-ws/build/recycle/gazebo2rviz" \
    install \
    $DESTDIR_ARG \
