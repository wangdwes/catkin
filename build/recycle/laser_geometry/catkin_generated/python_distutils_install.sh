...
cd "/home/dawei/catkin-ws/src/recycle/laser_geometry"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/dawei/catkin-ws/src/recycle/laser_geometry/setup.py" \
    build --build-base "/home/dawei/catkin-ws/build/recycle/laser_geometry" \
    install \
    $DESTDIR_ARG \
