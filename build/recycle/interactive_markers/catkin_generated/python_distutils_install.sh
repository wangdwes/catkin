...
cd "/home/dawei/catkin-ws/src/recycle/interactive_markers"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/dawei/catkin-ws/src/recycle/interactive_markers/setup.py" \
    build --build-base "/home/dawei/catkin-ws/build/recycle/interactive_markers" \
    install \
    $DESTDIR_ARG \
