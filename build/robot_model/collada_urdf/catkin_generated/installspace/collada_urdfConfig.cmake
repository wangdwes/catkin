...
if("FALSE" STREQUAL "TRUE")
  set(collada_urdf_SOURCE_PREFIX /home/dawei/catkin-ws/src/robot_model/collada_urdf)
  set(collada_urdf_DEVEL_PREFIX /home/dawei/catkin-ws/devel)
  ...
  set(collada_urdf_INSTALL_PREFIX /home/dawei/catkin-ws/install)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'collada_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dawei/catkin-ws/install/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
