...
cd "/home/dawei/catkin-ws/src/robot_model/resource_retriever"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/dawei/catkin-ws/src/robot_model/resource_retriever/setup.py" \
    build --build-base "/home/dawei/catkin-ws/build/robot_model/resource_retriever" \
    install \
    $DESTDIR_ARG \
