...
if("TRUE" STREQUAL "TRUE")
  set(interactive_markers_SOURCE_PREFIX /home/dawei/catkin-ws/src/recycle/interactive_markers)
...
if(NOT "/home/dawei/catkin-ws/src/recycle/interactive_markers/include" STREQUAL "")
  set(interactive_markers_INCLUDE_DIRS "")
  set(_include_dirs "/home/dawei/catkin-ws/src/recycle/interactive_markers/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'interactive_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dawei/catkin-ws/src/recycle/interactive_markers/${idir}'.  Ask the maintainer 'William Woodall <william@osrfoundation.org>' to fix it.")
    endif()
